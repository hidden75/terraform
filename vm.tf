...
resource "azurerm_network_interface_security_group_association" "db_security_group_association" {

  network_interface_id = azurerm_network_interface.db_vm_network_interface.id
...
resource "azurerm_windows_virtual_machine" "db_vm" {
  ...
  network_interface_ids = [
    ...
    azurerm_network_interface.db_vm_network_interface.id,
